...
function onPass()
     ...
     if num1 == 12 and num2 == 23 then
          onTeleportSong('pasta-night', 2)
          
     elseif num1 == 11 and num2 == 3 then
          onTeleportSong('Endless v12', 2)

     elseif num1 == 8 and num2 == 17 then
          onTeleportSong('endless-jp', 2)
          
     elseif num1 == 67 and num2 == 12 then
          onTeleportSong('fatality', 2)

     elseif num1 == 18 and num2 == 9 then
          onTeleportSong('Endeavors Unfair', 2)

     elseif num1 == 43 and num2 == 10 then
          onTeleportSong('Blue Entertainment', 2)

     elseif num1 == 12 and num2 == 25 then
          onTeleportSong('Infinite', 2)

     elseif num1 == 10 and num2 == 10 then
          onTeleportSong('Endless Encore', 2)

     elseif num1 == 25 and num2 == 12 then
          onTeleportSong('Endeavours', 2)

     elseif num1 == 0 and num2 == 0 then
          onTeleportSong('The Infinite Lament', 2)

     elseif num1 == 18 and num2 == 13 then
          onTeleportSong('Chaotic Endeavors Old', 2)

     elseif num1 == 12 and num2 == 12 then
          onTeleportSong('I like Potatoes', 2)
          else
