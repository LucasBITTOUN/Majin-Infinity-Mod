function onCreatePost()
	--Variable Shit
		...
		actnum = '3' -- the act number you want displayed, the options are: '1' '2' '1 no act text' '2 no act text'. if you are using Sonic 2 title cards, it can be whatever you want. if you are using Sonic 1 title cards, the options are: '1', '2', '3', '1 no act text', '2 no act text', '3 no act text'.
