...
function onCreate()
	...
	precacheImage("enginestuff/healthBorder")
	precacheImage("enginestuff/healthBar")
...
function onCreatePost()
	...
	if (settings.coolBar) then
		loadGraphic("healthBarBG", "enginestuff/healthBorder")
		setProperty("healthBarBG.yAdd", -34)
		setProperty("healthBarBG.xAdd", -54)
		
		makeLuaSprite("healthBarP1", "enginestuff/healthBar")
		makeLuaSprite("healthBarP2", "enginestuff/healthBar")
