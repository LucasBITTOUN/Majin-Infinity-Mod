...
local songData = { -- The main table that contains the songs you want credits on
    ...
    ['Endless'] = { -- This name NEEDS to be the name in the direct JSON/chart (e.g: dad-battle).
        ["songName"] = "Endless", -- The display name of the song.
        ["length"] = 5, -- The length the box is on screen.
        ["boxColor"] = "#000000", -- Color of Box (IN HEX).
        ["textColor"] = "#0112ffff", -- Color of Text (IN HEX).
